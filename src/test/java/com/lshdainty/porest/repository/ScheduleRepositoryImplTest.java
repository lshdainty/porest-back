...
public class ScheduleRepositoryImplTest {
    ...
    void getScheduleByUser() {
        ...
        String[] descs = {"교육", "출장"};
        ScheduleType[] types = {ScheduleType.EDUCATION, ScheduleType.BUSINESSTRIP};
    ...
    void getScheduleByStartEnd() {
        ...
        assertThat(findSchedules.get(0).getType()).isEqualTo(ScheduleType.EDUCATION);
    ...
    void getScheduleByStartEndBoundary() {
        ...
        assertThat(scheduleLeft.get(0).getType()).isEqualTo(ScheduleType.EDUCATION);
        ...
        assertThat(scheduleRight.get(0).getType()).isEqualTo(ScheduleType.BUSINESSTRIP);
