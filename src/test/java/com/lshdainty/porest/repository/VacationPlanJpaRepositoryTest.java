...
class VacationPlanJpaRepositoryTest {
    ...
    class FindByName {
        ...
        void findByNameSuccess() {
            ...
            // when
            Optional<VacationPlan> findPlan = vacationPlanRepository.findByName("기본 플랜");
        ...
        void findByNameNotFound() {
            // given & when
            Optional<VacationPlan> findPlan = vacationPlanRepository.findByName("없는 플랜");
    ...
    class FindAll {
        @Test
        @DisplayName("모든 플랜 조회 성공")
        void findAllSuccess() {
            // given
            VacationPlan plan1 = VacationPlan.createPlan("DEFAULT", "기본 플랜", "기본 휴가 플랜");
            ...
            assertThat(plans).extracting("code").containsExactly("DEFAULT", "SENIOR"); // code 오름차순
        }
        ...
        void findAllExcludesDeleted() {
            // given
            VacationPlan activePlan = VacationPlan.createPlan("ACTIVE", "활성 플랜", "활성 플랜");
            VacationPlan deletedPlan = VacationPlan.createPlan("DELETED", "삭제 플랜", "삭제 플랜");
