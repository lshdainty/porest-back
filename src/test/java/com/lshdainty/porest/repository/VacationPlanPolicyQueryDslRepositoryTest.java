...
import com.lshdainty.porest.vacation.repository.VacationPlanPolicyQueryDslRepository;
...
@DataJpaTest
@Import({VacationPlanPolicyQueryDslRepository.class, TestQuerydslConfig.class})
@Transactional
@DisplayName("QueryDSL 휴가 플랜-정책 매핑 레포지토리 테스트")
class VacationPlanPolicyQueryDslRepositoryTest {
    @Autowired
    private VacationPlanPolicyQueryDslRepository vacationPlanPolicyRepository;
