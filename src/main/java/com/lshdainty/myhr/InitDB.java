    ...
    static class InitService {
        ...
        public void initSetVacation() {
            ...
            List<VacationHistory> user1Annuals = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user1Annual, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 1, 2, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 1, 3, 23, 59, 59),
                    1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user1Annual, "1시간", VacationTimeType.ONETIMEOFF,
                            LocalDateTime.of(now.getYear(), 2, 3, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 2, 3, 10, 0, 0),
                    1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user1Annual, "연차", VacationTimeType.DAYOFF,
                    ...
                    VacationHistory.createUsedVacationHistory(user1Annual, "연차", VacationTimeType.DAYOFF,
                            ...
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user1Annual, "오전반차", VacationTimeType.MORNINGOFF,
                            LocalDateTime.of(now.getYear(), 10, 15, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 10, 15, 14, 0, 0),
                    1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user1Annual, "오후반차", VacationTimeType.AFTERNOONOFF,
                            LocalDateTime.of(now.getYear(), 12, 19, 14, 0, 0),
                            LocalDateTime.of(now.getYear(), 12, 19, 18, 0, 0),
                    1L, "127.0.0.1")
            );
            ...
            List<VacationHistory> user2Annuals = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user2Annual, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 4, 8, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 4, 8, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user2Annual, "1시간", VacationTimeType.ONETIMEOFF,
                            LocalDateTime.of(now.getYear(), 4, 9, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 4, 9, 10, 0, 0),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user2Annual, "연차", VacationTimeType.DAYOFF,
                    ...
                    VacationHistory.createUsedVacationHistory(user2Annual, "연차", VacationTimeType.DAYOFF,
                            ...
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user2Annual, "3시간", VacationTimeType.MORNINGOFF,
                            LocalDateTime.of(now.getYear(), 9, 8, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 9, 8, 12, 0, 0),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user2Annual, "오후반차", VacationTimeType.AFTERNOONOFF,
                            LocalDateTime.of(now.getYear(), 10, 10, 14, 0, 0),
                            LocalDateTime.of(now.getYear(), 10, 10, 18, 0, 0),
                            1L, "127.0.0.1")
            );
            ...
            List<VacationHistory> user3Annuals = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user3Annual, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 1, 2, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 1, 3, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user3Annual, "연차", VacationTimeType.DAYOFF,
                            ...
                            LocalDateTime.of(now.getYear(), 3, 17, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user3Annual, "2시간", VacationTimeType.ONETIMEOFF,
                            LocalDateTime.of(now.getYear(), 4, 9, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 4, 9, 11, 0, 0),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user3Annual, "연차", VacationTimeType.DAYOFF,
                    ...
                    VacationHistory.createUsedVacationHistory(user3Annual, "연차", VacationTimeType.DAYOFF,
                            ...
                            LocalDateTime.of(now.getYear(), 8, 14, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user3Annual, "오후반차", VacationTimeType.AFTERNOONOFF,
                            LocalDateTime.of(now.getYear(), 10, 10, 14, 0, 0),
                            LocalDateTime.of(now.getYear(), 10, 10, 18, 0, 0),
                            1L, "127.0.0.1")
            );
            ...
            List<VacationHistory> user4Annuals = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user4Annual, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 1, 2, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 1, 3, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user4Annual, "연차", VacationTimeType.DAYOFF,
            ...
            List<VacationHistory> user5Annuals = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user5Annual, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 1, 2, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 1, 3, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user5Annual, "연차", VacationTimeType.DAYOFF,
                    ...
                    VacationHistory.createUsedVacationHistory(user5Annual, "연차", VacationTimeType.DAYOFF,
                            ...
                            LocalDateTime.of(now.getYear(), 6, 2, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user5Annual, "연차", VacationTimeType.ONETIMEOFF,
            ...
            List<VacationHistory> user6Annuals = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user6Annual, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 4, 8, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 4, 8, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user6Annual, "1시간", VacationTimeType.ONETIMEOFF,
                            LocalDateTime.of(now.getYear(), 4, 9, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 4, 9, 10, 0, 0),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user6Annual, "연차", VacationTimeType.DAYOFF,
                    ...
                    VacationHistory.createUsedVacationHistory(user6Annual, "연차", VacationTimeType.DAYOFF,
                            ...
                            LocalDateTime.of(now.getYear(), 8, 14, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user6Annual, "3시간", VacationTimeType.MORNINGOFF,
                            LocalDateTime.of(now.getYear(), 9, 8, 9, 0, 0),
                            LocalDateTime.of(now.getYear(), 9, 8, 12, 0, 0),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user6Annual, "오후반차", VacationTimeType.AFTERNOONOFF,
                            LocalDateTime.of(now.getYear(), 10, 10, 14, 0, 0),
                            LocalDateTime.of(now.getYear(), 10, 10, 18, 0, 0),
                            1L, "127.0.0.1")
            );
            ...
            List<VacationHistory> user1Maternitys = List.of(
                    ...
                    VacationHistory.createUsedVacationHistory(user1Maternity, "연차", VacationTimeType.DAYOFF,
                            LocalDateTime.of(now.getYear(), 6, 2, 0, 0, 0),
                            LocalDateTime.of(now.getYear(), 6, 2, 23, 59, 59),
                            1L, "127.0.0.1"),
                    VacationHistory.createUsedVacationHistory(user1Maternity, "연차", VacationTimeType.DAYOFF,
